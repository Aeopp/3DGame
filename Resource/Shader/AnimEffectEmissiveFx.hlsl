...
PS_OUT PS_MAIN(PS_IN In)
{
    ...
    Out.Emissive = (DiffuseColor + AddColor) * Pattern;
    Out.Emissive *= Gradient;
    
    Out.Emissive.rgb *= Brightness;
    Out.Emissive.a *= AlphaFactor;
    ...
    Out.Emissive.a = Out.Emissive.a * saturate(((fViewZ - In.ClipPosition.z / In.ClipPosition.w) * SoftParticleDepthScale));
