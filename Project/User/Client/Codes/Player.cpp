...
void Player::Update(const float DeltaTime)&
{
	...
	if(bNPCInteraction)
		RefFontManager().RenderFont(L"Font_Sandoll", L"NPC 의 대화 멘트.", { 300,200 }, D3DXCOLOR{ 1.f,1.f,1.f,1.f });
	...
	const float CrossAreaScale)&
{
		...
		_NPC)
	{
		...
		// 	RefFontManager().AddFont(Device, L"Font_Sandoll", L"Sandoll 삼립호빵체 Outline", 15, 20, FW_THIN);
