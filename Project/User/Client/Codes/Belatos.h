...
public:
	...
	enum class State : uint8
	{
		...
		RTDownAirLandingFront,//RTDown_Air_Landing_B_L_Belatos_Twohandedsword
...
private:
	...
	void RTDownAirLandingFrontState(const FSMControlInformation& FSMControlInfo)&;
	void RTDownAirLandingFrontTransition(const FSMControlInformation& FSMControlInfo)&;
...
private:
	static inline std::optional<Engine::ThirdPersonCamera::TargetInformation> SpawnCameraEvent{};

	float SmallAirAttackRange = 100.f;
